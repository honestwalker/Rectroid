...
import com.honestwalker.android.xview.utils.ActivityUtil;
...
public class ComponentActivity extends FragmentActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        xViewDemo = (XView) findViewById(R.id.content);

        componentView = xViewDemo.inject(mainComponent);
